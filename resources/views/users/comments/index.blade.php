...
<form action="{{ route('users.index', $user->id) }}" method="get" class="py-5">
    ...
    @foreach ($comments as $comment)
        <tr>
            ...
            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                <a href="{{ route('users.edit', ['user' => $user->id, 'id' => $comment->id]) }}" class="bg-green-200 rounded-full py-2 px-6">Editar</a>
            </td>
        </tr>
    @endforeach
    </tbody>
